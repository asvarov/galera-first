...
docker exec compose_pdns-server-1_1 pdnsutil add-record lab2.jelastic.team ns1 A 192.168.3.2
docker exec compose_pdns-server-1_1 pdnsutil add-record lab2.jelastic.team ns2 A 192.168.2.2
